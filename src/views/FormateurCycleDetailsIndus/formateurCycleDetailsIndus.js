...
function FormateurCycleDetailsIndus() {
    ...
    const addFile = (e) => {
        ...
        data.append('id_induses',location.state.id);
        data.append('titre', fileName.titre);
        data.append('file_path',file.file);

        axios.post("api/files-indus",data).then(res=>{
    ...
    const updateLink = (e) => {
        ...
        console.log(data)
        axios.post(`api/cycle_indus/${location.state.id}`,data).then(res=>{
        ...
        <div className="cont w-100 ">
            ...
            <div className="row m-1">
                ...
                <div className="col-12">
                    <h4 className='display-4 d-flex align-self-center  '>Liste de fichiers</h4>
...
export default FormateurCycleDetailsIndus;